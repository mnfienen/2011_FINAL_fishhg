...
def resid_plotter(x,y,DL,logFlag,figtitle,figname,subf):
...
class RRS_post:
    ...
    def parse_input(self):
        ...
        SpC_count3 = self.indat['SpC_Count3']
       # self.count_lookup = np.vstack((self.eunich_spc,np.zeros_like(self.eunich_spc)))
       # for i in self.eunich_spc:
       #     self.count_lookup[i,1] = SpC_count3
